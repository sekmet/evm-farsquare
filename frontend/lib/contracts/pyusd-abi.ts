 ...
 * PYUSD Token ABI
 *
 * PayPal USD (PYUSD) is a stablecoin issued by PayPal.
 * ERC-20 compatible token with additional features like freezing, pausing, and supply control.
 */
...
export const pyusdAbi = [
  ...
  {
    inputs: [],
    name: "AuthorizationInvalid",
    type: "error",
  },
  {
    inputs: [],
    name: "BlockedAccountAuthorizer",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "OnlySupplyControllerOrOwner",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "SupplyControllerUnchanged",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "address", name: "newSanctionedAddress", type: "address" },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "address", name: "supplyControlAddress", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "supplyControlAddress", type: "address" }],
