/**
 * ERC-3643 IIdentity Interface ABI
 *
 * ERC-734 Key Manager and ERC-735 Claim Manager interface
 * Defines standard functions for decentralized identity contracts
 */

export const iIdentityAbi = [
  // Events
  {
    anonymous: false,
    inputs: [
