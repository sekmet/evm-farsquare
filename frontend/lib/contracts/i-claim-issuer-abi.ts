/**
 * ERC-3643 IClaimIssuer Interface ABI
 *
 * Claim issuer interface extending IIdentity
 * Defines functions for authorized claim issuers to validate identities
 */

export const iClaimIssuerAbi = [
  // Events (same as IIdentity)
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "uint256", name: "claimRequestId", type: "uint256" },
      { indexed: true, internalType: "uint256", name: "topic", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "scheme", type: "uint256" },
      { indexed: true, internalType: "address", name: "issuer", type: "address" },
      { indexed: false, internalType: "bytes", name: "signature", type: "bytes" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "uint256", name: "purpose", type: "uint256" },
      { indexed: true, internalType: "uint256", name: "keyType", type: "uint256" },
    ],
    name: "KeyAdded",
    type: "event",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_keyType", type: "uint256" },
    ],
    name: "addKey",
  ...
  },
  {
    ...
    name: "getKey",
    outputs: [
      { internalType: "uint256", name: "purpose", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_purpose", type: "uint256" }],
    name: "getKeysByPurpose",
    outputs: [{ internalType: "bytes32[]", name: "keys", type: "bytes32[]" }],
    stateMutability: "view",
    type: "function",
  },
  // IClaimIssuer specific functions
  {
    inputs: [],
    name: "isClaimIssuer",
...
export default iClaimIssuerAbi
