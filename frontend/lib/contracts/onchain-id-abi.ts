/**
 * ERC-3643 OnchainID ABI
 *
 * Decentralized identity contract implementing ERC-734 and ERC-735 standards
 * Manages cryptographic keys, claims, and identity verification
 */

export const onchainIdAbi = [
  // Constructor
  {
    inputs: [
  ...
  },
  {
    ...
    name: "getKey",
    outputs: [
      { internalType: "uint256", name: "purposes", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [{ internalType: "bytes32[]", name: "_keys", type: "bytes32[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
