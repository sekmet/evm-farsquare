 ...
 */
async function monitorERC3643Transfers(contractAddress: Address, callback: (log: Log) => void): Promise<() => void> {
  try {
 ...
 */
async function getContractActivity(contractAddress: Address): Promise<{
