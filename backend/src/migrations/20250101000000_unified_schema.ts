...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addColumn('id', 'uuid', (col) => col.defaultTo(sql`gen_random_uuid()`).primaryKey())
    .addColumn('contract_address', 'varchar(255)', (col) => col.notNull().unique())
    ...
    .addColumn('identity_registry_contract', 'varchar(255)')
    .addColumn('compliance_contract', 'varchar(255)')
    .addColumn('paused', 'boolean', (col) => col.defaultTo(false))
    .addColumn('owner_address', 'varchar(255)', (col) => col.notNull())
    .addColumn('created_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`).notNull())
    .addColumn('updated_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`).notNull())
    .addColumn('deployed_at', 'timestamptz')
    .addColumn('deployed_tx_hash', 'varchar(255)')
    .execute()
  ...
  await db.schema
    ...
    .addColumn('identity_registry_contract', 'varchar(255)')
    .addColumn('compliance_contract', 'varchar(255)')
    .addColumn('identity_storage_contract', 'varchar(255)')
    .addColumn('claim_topics_registry_contract', 'varchar(255)')
    .addColumn('trusted_issuers_registry_contract', 'varchar(255)')
    .addColumn('deployed_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`).notNull())
    .addColumn('deployed_by', 'varchar(255)', (col) => col.notNull())
    .addColumn('deployed_tx_hash', 'varchar(255)')
  ...
  await db.schema
    ...
    .addColumn('user_address', 'varchar(255)', (col) => col.primaryKey())
    .addColumn('identity_contract', 'varchar(255)', (col) => col.notNull())
    ...
    .addColumn('registered_by', 'varchar(255)')
    .addColumn('updated_at', 'timestamptz', (col) => col.defaultTo(sql`NOW()`).notNull())
  ...
  await db.schema
    ...
    .addColumn('id', 'uuid', (col) => col.defaultTo(sql`gen_random_uuid()`).primaryKey())
    .addColumn('identity_address', 'varchar(255)', (col) => col.notNull().references('public.identities.user_address'))
  ...
  await db.schema
    ...
    .addColumn('issuer_address', 'varchar(255)', (col) => col.primaryKey())
  ...
  await db.schema
    ...
    .addColumn('module_address', 'varchar(255)', (col) => col.primaryKey())
  ...
  await db.schema
    ...
    .addColumn('id', 'uuid', (col) => col.defaultTo(sql`gen_random_uuid()`).primaryKey())
    .addColumn('token_contract', 'varchar(255)', (col) => col.notNull())
  ...
  await db.schema
    ...
    .addColumn('token_contract', 'varchar(255)', (col) => col.notNull())
    .addColumn('agent_address', 'varchar(255)', (col) => col.notNull())
  ...
  await db.schema
    ...
    .addColumn('token_contract', 'varchar(255)', (col) => col.references('public.tokens.contract_address'))
  ...
  await db.schema
    ...
    .addColumn('user_address', 'varchar(255)')
  ...
  await db.schema
    ...
    .addColumn('deployed_at', 'timestamptz')
    .addColumn('deployed_by', 'varchar(255)')
